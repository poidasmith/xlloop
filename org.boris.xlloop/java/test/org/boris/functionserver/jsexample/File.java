 ...
 * 
 * This isn't intended to be any sort of definitive attempt at a standard File
 * object for JavaScript, but instead is an example of a more involved
 * definition of a host object.
 * 
 ...
 * 
 * 
 * File errors or end-of-file signaled by thrown Java exceptions will be wrapped
 * as JavaScript exceptions when called from JavaScript, and may be caught
 * within JavaScript.
 * 
 * @author Norris Boyd
 */
public class File extends ScriptableObject {
     ...
     * <p>
     * 
     * Otherwise System.in or System.out is assumed as appropriate to the use.
     */
     ...
     * <p>
     * 
     * This is a good example of creating a new array and setting elements in
     * that array.
     * 
     ...
     * <p>
     * 
     * This function takes a variable number of arguments, converts each
     * argument to a string, and writes that string to the file.
     * 
     * @exception IOException if an error occurred while accessing the file
     *                associated with this object
     */
     ...
     * 
     * Since the two functions differ only in whether they write a newline
     * character, move the code into a common subroutine.
     * 
     */
     ...
     * 
     * This is necessary since methods may reside in the File.prototype object
     * and scripts can dynamically alter prototype chains. For example:
     * 
     * <pre>
     * js&gt; defineClass(&quot;File&quot;);
     * js&gt; o = {};
