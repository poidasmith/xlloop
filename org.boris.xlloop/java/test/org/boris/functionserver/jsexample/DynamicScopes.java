...
public class DynamicScopes {
     ...
     * Main entry point.
     * 
     * Set up the shared scope and then spawn new threads that execute relative
     * to that shared scope. Try to run functions with and without dynamic scope
     * to see the effect.
     * 
     ...
     * </pre>
     * 
     * The final three lines may be permuted in any order depending on thread
     * scheduling.
     */
